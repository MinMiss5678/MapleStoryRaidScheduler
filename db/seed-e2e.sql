...
BEGIN
    ...
    INSERT INTO "Character"("Id","DiscordId","Name","Job","AttackPower","Level")
    VALUES ('c2001', 2001, 'CNew', '英雄', 950, 200);

    -- leader-led Push e2e：申請者 P-LL(6002)（直接申請入隊，不需常設時段）
    INSERT INTO "Player"("DiscordId","DiscordName","Role") VALUES (6002, 'P-LL', 'user');
    INSERT INTO "Character"("Id","DiscordId","Name","Job","AttackPower","Level")
    VALUES ('c6002', 6002, 'C-LL', '英雄', 950, 200);
    ...
    INSERT INTO "Character"("Id","DiscordId","Name","Job","AttackPower","Level")
    VALUES ('c6003', 6003, 'C-Cand', '英雄', 950, 200);
    ...
    INSERT INTO "Character"("Id","DiscordId","Name","Job","AttackPower","Level")
    VALUES ('c6005', 6005, 'C-Full-A', '夜使者', 950, 200);
    INSERT INTO "PlayerAvailabilityStanding"("DiscordId","Weekday","StartTime","EndTime")
    ...
    INSERT INTO "Character"("Id","DiscordId","Name","Job","AttackPower","Level")
    VALUES ('c6006', 6006, 'C-Full-B', '夜使者', 950, 200);
    INSERT INTO "PlayerAvailabilityStanding"("DiscordId","Weekday","StartTime","EndTime")
    ...
    INSERT INTO "Character"("Id","DiscordId","Name","Job","AttackPower","Level")
    VALUES ('c7002', 7002, 'C-Trans', '英雄', 950, 200);
...
INSERT INTO "Character"("Id","DiscordId","Name","Job","AttackPower","Level") VALUES ('c8101', 8101, 'C-Lfg', '夜使者', 950, 200);
